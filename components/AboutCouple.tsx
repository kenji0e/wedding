...
const AboutCouple: React.FC = () => {
  return (
    <section id="about-couple" className="py-8 md:py-16 bg-gradient-to-t from-pink-50 to-white text-gray-800">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-center text-lg md:text-xl leading-relaxed mb-12 text-gray-700 max-w-3xl mx-auto italic">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 mb-16">
          ...
          <div className="text-center group">
            <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden border-4 border-pink-300 shadow-xl group-hover:border-pink-500 transition duration-300 transform group-hover:scale-105">
              <img
                src="/images/1.png" // Ganti dengan gambar Sarah
                alt="Sarah Amelia"
          ...
          <div className="text-center group">
            <div className="relative w-48 h-48 mx-auto mb-4 rounded-full overflow-hidden border-4 border-pink-300 shadow-xl group-hover:border-pink-500 transition duration-300 transform group-hover:scale-105">
              <img
                src="/images/2.png" // Ganti dengan gambar David
                alt="David Pratama"
                className="w-full h-full object-cover"
              />
        ...
        <p className="text-center text-lg md:text-xl leading-relaxed text-gray-700 max-w-3xl mx-auto">
